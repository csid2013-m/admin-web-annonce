...
// CB layout:
	...
	CB_WindowColor='#F0EFEF',				// color of the CB window (note: you have to change the rounded-corner PNGs too!), transparent is also working
	CB_MinWidth=500,				// minimum (only at images) or initial width of CB window
	...
	CB_ThumbsBGOpacity=0.35,				// opacity of the thumbnail layer
...
// Settings of the document-hiding layer:
	...
	CB_HideOpacity=0.5,				// opacity (0 is invisible, 1 is 100% color) of the layer
